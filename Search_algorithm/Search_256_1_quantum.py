...
init_super = product_all((('H', n, 0), ('H', n, 1), ('H', n, 2), ('H', n, 3), ('H', n, 4), ('H', n, 5), ('H', n, 6),
                          ('H', n, 7), ('H', n, 8)))
grover_unit = product_all((('X', n, 8, (1, 2, 3, 4, 5, 6, 7), (0,)), ('H', n, 0), ('H', n, 1),
                           ('H', n, 2), ('H', n, 3), ('H', n, 4), ('H', n, 5), ('H', n, 6), ('H', n, 7),
                           ('X', n, 0), ('X', n, 1), ('X', n, 2), ('X', n, 3), ('X', n, 4),
                           ('X', n, 5), ('X', n, 6), ('X', n, 7),
                           ('H', n, 7), ('X', n, 7, (0, 1, 2, 3, 4, 5, 6)), ('H', n, 7),
                           ('X', n, 0), ('X', n, 1), ('X', n, 2), ('X', n, 3),
                           ('X', n, 4), ('X', n, 5), ('X', n, 6), ('X', n, 7),
                           ('H', n, 0), ('H', n, 1), ('H', n, 2), ('H', n, 3),
                           ('H', n, 4), ('H', n, 5), ('H', n, 6), ('H', n, 7)))
out_gate = product_all((('H', n, 8),))
...
for iter_times in range(0, iter_max):
    ...
    q_vec.in_gate(cir_U)
    q_vec.calc_pos()
    pos_applytimes[iter_times] = round(q_vec.calc_pos_state((0, 1, 1, 1, 1, 1, 1, 1, 1)), 4)

print(pos_applytimes)
theta = 2 * np.arccos(np.sqrt((N - M) / N))
x = np.linspace(0, iter_max, 1000)
y = (np.sin((x + 1 / 2) * theta)) ** 2
plt.plot(x, y, linestyle='--', label=u'理论预期')
