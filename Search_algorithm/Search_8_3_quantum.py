...
grover_unit = product_all((('X', n, 3, (1,), (0,)), ('X', n, 3, None, (0, 1, 2)), ('H', n, 0), ('H', n, 1),
...
for iter_times in range(0, iter_max):
    ...
    pos_applytimes[iter_times] = \
        round(q_vec.calc_pos_state((0, 1, 1, 1)) +
              q_vec.calc_pos_state((0, 1, 0, 1)) +
              q_vec.calc_pos_state((0, 0, 0, 1)), 4)
