...
init_super = product_all((('H', n, 0), ('H', n, 1), ('H', n, 2), ('H', n, 3), ('H', n, 4)))
grover_unit = product_all((('X', n, 4, (1, 2, 3), (0,)), ('H', n, 0), ('H', n, 1),
                           ('H', n, 2), ('H', n, 3), ('X', n, 0), ('X', n, 1), ('X', n, 2), ('X', n, 3),
                           ('H', n, 3), ('X', n, 3, (0, 1, 2)), ('H', n, 3),
                           ('X', n, 0), ('X', n, 1), ('X', n, 2), ('X', n, 3),
                           ('H', n, 0), ('H', n, 1), ('H', n, 2), ('H', n, 3)))
out_gate = product_all((('H', n, 4),))
...
for iter_times in range(0, iter_max):
    ...
    q_vec.in_gate(cir_U)
    q_vec.calc_pos()
    pos_applytimes[iter_times] = round(q_vec.calc_pos_state((0, 1, 1, 1, 1)), 4)
