...
grover_unit = product_all((('X', n, 2, 0), ('H', n, 0), ('H', n, 1),
                           ('X', n, 0), ('X', n, 1), ('H', n, 1),
                           ('X', n, 1, 0), ('H', n, 1), ('X', n, 0), ('X', n, 1),
                           ('H', n, 0), ('H', n, 1)))
out_gate = product_all((('H', n, 2),))
iter_max = 10
...
for iter_times in range(0, iter_max):
    ...
    pos_applytimes[iter_times] = \
        round(q_vec.calc_pos_state((1, 1, 1)) + q_vec.calc_pos_state((1, 0, 1)), 3)
